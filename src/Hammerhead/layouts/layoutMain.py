...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelButtonDomain = QtWidgets.QLabel(self.centralwidget)
        self.labelButtonDomain.setGeometry(QtCore.QRect(370, 622, 50, 58))
        self.labelButtonDomain.setMouseTracking(True)
        self.labelButtonDomain.setText("")
        self.labelButtonDomain.setObjectName("labelButtonDomain")
